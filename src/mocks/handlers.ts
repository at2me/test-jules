...
export const handlers = [
  ...
  http.get('/api/actions', () => {
    return HttpResponse.json([
      { id: 1, type: 'playback', priority: 1, enable: true, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
      { id: 2, type: 'transfer', priority: 2, enable: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    ]);
  }),
